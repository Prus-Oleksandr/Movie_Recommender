...
class IndexViewTest(TestCase):
    def setUp(self):
        ...
        self.user.favorite_genres.add(self.genre)  # Обов'язково додаємо жанр, щоб пройти перевірку
        self.url = reverse("index")

    def test_index_redirects_user_without_preferences(self):
        user_no_prefs = User.objects.create_user(username="no_prefs", password="password123")
